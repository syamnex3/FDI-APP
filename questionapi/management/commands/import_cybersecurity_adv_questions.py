...
from questionapi.models import CybersecurityQuestion_Adv

questions = [
    {
        "question_id": "cs_q_1",
        "question_text_full": "How would you define cryptography?",
        ...
        "options": [
            "A technique for compressing information for storage",
            "A method for debugging code",
            "A practice of securing communication and information",
    ...
    {
        "question_id": "cs_q_2",
        "question_text_full": "How does symmetric encryption differ from asymmetric encryption?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
        ...
        "topic": "Cybersecurity Fundamentals",
        "options": [
            "Symmetric uses different keys; Asymmetric uses same key",
            "Symmetric is slower; Asymmetric is faster",
            "Symmetric uses same key for encryption and decryption; Asymmetric uses different keys",
            "Both use the same keys for all operations"
        ],
        "correct_answers": [2]
    },
    {
        "question_id": "cs_q_3",
        "question_text_full": "In what ways do IDS and IPS differ?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
        ...
        "topic": "Cybersecurity Fundamentals",
        "options": [
            "IDS detects intrusions and prevents them; IPS only detects",
            "IDS prevents intrusions; IPS only reports them",
            "IDS only detects intrusions; IPS detects and prevents them",
            "IDS blocks intrusions automatically; IPS requires manual action"
        ],
        "correct_answers": [2]
    },
    {
        "question_id": "cs_q_4",
        "question_text_full": "In cybersecurity, what does the acronym CIA represent?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
        ...
        "options": [
            ...
            "Compliance, Intrusion, Alert"
        ],
        "correct_answers": [1]
    },
    {
        "question_id": "cs_q_5",
        "question_text_full": "What makes encryption and hashing fundamentally different?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
        ...
        "options": [
            ...
            "Encryption is irreversible; hashing is reversible",
            "Encrypted data can be decrypted; hashed data cannot be reversed",
            "Encryption is used to validate data integrity"
        ],
        "correct_answers": [2]
    },
    {
        "question_id": "cs_q_6",
        "question_text_full": "Why is a firewall important in cybersecurity?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
    ...
    {
        "question_id": "cs_q_7",
        "question_text_full": "How do penetration testing and vulnerability assessment differ?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
        ...
        "topic": "Cybersecurity Fundamentals",
        "options": [
            "PT finds and reports issues; VA fixes them",
            "VA is done post-exploit; PT is proactive",
            "VA finds flaws; PT tests exploitation of those flaws",
            "VA fixes system configurations; PT updates firewalls"
        ],
        "correct_answers": [2]
    },
    {
        "question_id": "cs_q_8",
        "question_text_full": "What is the process of the TCP three-way handshake?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
    ...
    {
        "question_id": "cs_q_9",
        "question_text_full": "Which HTTP status codes indicate an error caused by the client?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
    ...
    {
        "question_id": "cs_q_10",
        "question_text_full": "What information does the traceroute command provide?",
        "question_type": "Multiple Choice",
        "difficulty": "Intermediate",
        "depth_of_knowledge": "Recall",
        "domain": "Cybersecurity",
        ...
        "topic": "Cybersecurity Fundamentals",
        "options": [
            "To trace viruses in email",
            "To identify the hops a packet takes to reach a destination",
            "To secure the route of packets",
            "To analyze encrypted network sessions"
        ],
        "correct_answers": [1]
    },
...
class Command(BaseCommand):
    help = 'Import CybersecurityQuestion_Adv'

    def handle(self, *args, **kwargs):
        for q in questions:
            CybersecurityQuestion_Adv.objects.update_or_create(
        ...
        self.stdout.write(self.style.SUCCESS('All advanced cybersecurity questions imported!'))